            ...
            <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div id="modalbody" class="modal-body" style="padding:12px;">
                        </div>
...
<script type="text/javascript">
    ...
    function initTable() {
        $table.bootstrapTable({
            url: '/back/Communicate/Messagelist',
            showColumns: true,
    ...
    function operateFormatter(value, row, index) {
        ...
        return [
            ...
            , '<button type="button" data-toggle="modal" data-target="#myModal" class="btn no-border" onclick="reading(mymid)">查看 </button>',
            '</a> '
        ].join('');
    }
    ...
    function reading(mid) {
        $.ajax({
            type: "POST",
            url: "/back/Communicate/getread",
            data: "Messageid="+mid,
            success: function(data){
                $('#myModalLabel').html(data.uId+'的黑名单');
                var list = data.blacklist.split("&");
                $("#modalbody").html("<div style='margin-left: 30px'>"+list+"</div>");
            }
        });
    }

...
<![endif]-->
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				//initimg();
				function initimg() {
					$.post('/back/album/getlist', {uid: $('#uId').val(),offset:0,limit:1}, function (data) {
						if (data.total!=null) {
							$('#imgcontain').append(
									'<li><div>'+
									'<img alt="150x150" src="/static/ace/assets/images/gallery/thumb-5.jpg" width="150" height="150">'+
									'<div class="text"><div class="inner"><span>Some Title!</span>'+
									'<br>'+
							'<a href="/static/ace/assets/images/gallery/image-5.jpg" data-rel="colorbox" class="cboxElement">'+

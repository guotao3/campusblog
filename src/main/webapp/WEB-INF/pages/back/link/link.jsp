        ...
        <div class="page-content">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title">友情链接详细</h3>
                </div>
                <div id="div-advanced-search" style="display: none">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <form class="form-group">
                                <label for="companyid" class="col-sm-1 control-label">编号</label>
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" id="companyid" placeholder="工商注册号"/>
                                </div>
                                ...
                                <label for="logo" style="margin-top: 20px;" class="col-sm-1 control-label">logourl</label>
                                ...
                                <div style="margin-top: 20px;" class="col-sm-4">
                                    <button class="btn btn-purple btn-sm" type="button" id="addlink">
                ...
                <div class="panel-body">
                    <table id="mytable" class="table">
                        <th>注册号</th><th>名称 </th><th>@email</th><th>操作</th>

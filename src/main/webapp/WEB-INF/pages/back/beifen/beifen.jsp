        ...
        <div class="page-content">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h3 class="panel-title">数据管理备份</h3>
                </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <form class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" readonly="true" value="${sessionScope.admin.uId}"/>
                                </div>

                                <label class="col-sm-1 control-label">备份信息</label>
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" id="commit"/>
                                </div>

                                <div  class="col-sm-4">
                                    <button class="btn btn-purple btn-sm" type="button" id="addback">
